    ...
    */
    ...
    public void sm2Verify(byte md[], ECPoint userKey, BigInteger r, BigInteger s, SM2Result sm2Result) {
        ...
        if (t.equals(BigInteger.ZERO)) {
            ...
            System.out.println("计算曲线点X0: " + x1y1.getXCoord().toBigInteger().toString(16));
            System.out.println("计算曲线点Y0: " + x1y1.getYCoord().toBigInteger().toString(16));
            System.out.println("");

            x1y1 = x1y1.add(userKey.multiply(t));
            System.out.println("计算曲线点X1: " + x1y1.getXCoord().toBigInteger().toString(16));
            System.out.println("计算曲线点Y1: " + x1y1.getYCoord().toBigInteger().toString(16));
            System.out.println("");
